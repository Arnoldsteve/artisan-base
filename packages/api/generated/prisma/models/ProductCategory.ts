...
export type ProductCategoryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tenantId" | "productId" | "categoryId", ExtArgs["result"]["productCategory"]>
...
export interface ProductCategoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const productCategoryWithTenantIdOnly = await prisma.productCategory.findMany({ select: { tenantId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProductCategories and only return the `tenantId`
   * const productCategoryWithTenantIdOnly = await prisma.productCategory.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProductCategories and only return the `tenantId`
   * const productCategoryWithTenantIdOnly = await prisma.productCategory.updateManyAndReturn({
   *   select: { tenantId: true },
   *   where: {
   *     // ... provide filter here
   *   },
