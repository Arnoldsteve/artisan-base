...
export function SetupOrganizationForm() {
  ...
  // --- All state and useEffects remain the same. No changes needed. ---
  ...
  useEffect(() => {
    const checkAvailability = async () => {
      ...
      try {
        const data =
          await api.tenant.checkSubdomainAvailability(debouncedSubdomain);
        if (data.isAvailable) {
...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  try {
      ...
      // The rest of the success logic is correct!
      ...
      // The backend returns an array of messages, so let's join them.
  ...
  // --- The entire JSX return remains exactly the same. No changes needed. ---
