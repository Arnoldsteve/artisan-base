...
export function BillingPlanOptions({
  ...
  const { plans, subscription, changePlan, loading, error } = useBilling();
  const availablePlans = propPlans || plans;
  const currentPlanId = propCurrentPlanId || subscription?.plan.id;
          ...
          <Card key={plan.id} className="flex flex-col">
            ...
            <CardFooter>
              {currentPlanId === plan.id ? (
                ...
                <Button onClick={() => changePlan(plan.id)} className="w-full">
