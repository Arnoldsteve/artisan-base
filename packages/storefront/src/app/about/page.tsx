  ...
  return (
    <section className="py-4 bg-[#f4f4f4]">
      <div className="container mx-auto px-4 py-8 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="p-6">
            ...
            <CardContent className="text-muted-foreground space-y-2">
              <p>
                At Artisan Base, we believe in the power of handcrafted goods
                and the stories they tell. Our mission is to provide a platform
                where skilled artisans can showcase their unique creations and
                connect with customers who appreciate quality craftsmanship.
              </p>
              <p>
        ...
        {/* Values Section */}
        <div>
          <h2 className="text-2xl font-bold text-foreground mb-8 text-start">
            Our Values
          </h2>
        ...
        <Card className="p-6">
          <CardHeader>
            <CardTitle className="text-start">Our Story</CardTitle>
          </CardHeader>
          <CardContent className="text-muted-foreground space-y-4">
            ...
            <p>
              Our journey began when we discovered the incredible talent of
              local artisans who were struggling to reach customers beyond their
            ...
            <p>
              Today, we're proud to support hundreds of artisans across the
              globe, helping them turn their passion into sustainable businesses
              while bringing unique, beautiful products to homes everywhere.
            </p>
          </CardContent>
        </Card>
